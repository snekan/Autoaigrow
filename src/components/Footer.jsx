      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.35)', lineHeight: 1.7, maxWidth: 240 }}>
              Building scalable AI systems and intelligent automation for the future of modern business.
            </p>
            <a
              href="https://autoaigrow.com"
              style={{ fontSize: '0.8rem', color: 'rgba(0,212,255,0.6)', textDecoration: 'none' }}
              target="_blank"
          ...
          {/* Navigation */}
          <div>
            <div style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.12em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', marginBottom: 16 }}>
              Navigation
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-4 mt-2">
                {/* GitHub */}
                <a
                  href="https://github.com/autoaigrow"
                  target="_blank"
                  rel="noopener noreferrer"
                  id="github-link"
                  style={{
                ...
                {/* LinkedIn */}
                <a
                  href="https://linkedin.com/company/autoaigrow"
                  target="_blank"
                  rel="noopener noreferrer"
                  id="linkedin-link"
                  style={{
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.25)' }}>
            © 2025 Auto AI Grow. All rights reserved.
          </p>
          <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.2)' }}>
            Intelligent AI Systems for the Future
          </p>
        </div>
      </div>
    </footer>
